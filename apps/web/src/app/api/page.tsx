    ...
    <AppShell user={user} title="API" current="api" roomy>
      ...
      <div className="space-y-8">
        ...
        <section aria-labelledby="auth-heading">
          <div className="mb-3">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-brand">02 · Authentication</p>
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <InfoCard title="read · 조회" value="GET /terms">검색·상세 조회·배치 조회·RAG 검색처럼 읽기 작업에 필요한 권한입니다.</InfoCard>
        ...
        <section aria-labelledby="endpoints-heading">
          <div className="mb-3">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-brand">03 · Endpoints</p>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]" aria-labelledby="response-heading">
          <div className="card p-5 sm:p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-brand">04 · Safe updates</p>
          ...
          <div className="card p-5 sm:p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-brand">05 · Full contract</p>
